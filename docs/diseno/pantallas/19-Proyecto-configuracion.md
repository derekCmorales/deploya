...
| Historias | M3-04 |
| Entrega | A3 |
| Diseño | Canvas Deploya v4.1, artboard `19-Proyecto-configuracion` (https://claude.ai/artifact/B89rty3MNxRKW9RHJQwSZT) |

## Qué es

General, Fuente, Contenedor; «Zona de peligro» con Eliminar proyecto.
